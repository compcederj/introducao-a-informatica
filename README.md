...
Repositório de provas antigas da Disciplina **Introdução à Informática** do curso de **Tecnologia em Sistemas de Computaćao** da **UFF** ministrado através do **CEDERJ**.
...
`git clone https://github.com/compcederj/introducao-a-informatica.git`
...
`git clone git@github.com:compcederj/introducao-a-informatica.git`
...
# Introdução à Informática
Repositório de provas antingas da Disciplina **Introdução à Informática** do curso de **Tecnologia em Sistemas de Computaçao** da **UFF** ministrado através do **CEDERJ**.
